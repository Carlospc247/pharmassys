    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_hierarquico', models.IntegerField(default=1, help_text='1 = Mais alto na hierarquia')),
                ('categoria', models.CharField(choices=[('diretoria', 'Diretoria'), ('gerencia', 'Gerência'), ('coordenacao', 'Coordenação'), ('supervisao', 'Supervisão'), ('operacional', 'Operacional'), ('tecnico', 'Técnico'), ('administrativo', 'Administrativo'), ('vendas', 'Vendas'), ('direcao_tecnica', 'Direção Técnica'), ('estagiario', 'Estagiário'), ('terceirizado', 'Terceirizado'), ('rh', 'Recursos Humanos'), ('financeiro', 'Contabilidade'), ('outros', 'Outros')], default='operacional', max_length=15)),
                ('salario_base', models.DecimalField(blank=True, decimal_places=2, help_text='Salário base para o cargo', max_digits=10, null=True)),
                ('vale_alimentacao', models.DecimalField(decimal_places=2, default=0, help_text='Valor do vale alimentação', max_digits=8)),
                ('vale_transporte', models.DecimalField(decimal_places=2, default=0, help_text='Valor do vale transporte', max_digits=8)),
                ('pode_dispensar_medicamentos', models.BooleanField(default=False)),
                ('pode_dispensar_controlados', models.BooleanField(default=False)),
                ('pode_prescrever', models.BooleanField(default=False)),
                ('requer_ofa', models.BooleanField(default=False, help_text='Requer registro no OFA')),
                ('pode_vender', models.BooleanField(default=True)),
                ('pode_fazer_desconto', models.BooleanField(default=False)),
                ('limite_desconto_percentual', models.DecimalField(decimal_places=2, default=0, help_text='Limite máximo de desconto em %', max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ativo', models.BooleanField(default=True)),
                ('loja', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departamentos', to='core.loja')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('matricula', models.CharField(help_text='Matrícula do funcionário', max_length=20, unique=True)),
                ...
                ('tipo_contrato', models.CharField(choices=[('clt', 'CLT'), ('pj', 'Pessoa Jurídica'), ('estagiario', 'Estagiário'), ('terceirizado', 'Terceirizado'), ('freelancer', 'Freelancer'), ('voluntario', 'Voluntário')], default='clt', max_length=15)),
        ...
        migrations.AlterUniqueTogether(
            name='funcionario',
            unique_together={('matricula', 'empresa')},
        ),
        migrations.AlterUniqueTogether(
            name='escalatrabalho',

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('laboratorio', 'Laboratório Farmacêutico'), ('distribuidor', 'Distribuidor'), ('atacadista', 'Atacadista'), ('importador', 'Importador'), ('representante', 'Representante'), ('cooperativa', 'Cooperativa'), ('prestador_servico', 'Prestador de Serviço'), ('armazem', 'Armazem'), ('outros', 'Outros')], default='distribuidor', max_length=20)),
                ...
                ('kwik_chave', models.CharField(blank=True, help_text='Chave kwik', max_length=100)),

# Generated by Django 5.1.5 on 2025-11-10 22:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorias', models.ManyToManyField(blank=True, help_text='Categorias incluídas (vazio = todas)', to='core.categoria')),
                ...
                ('responsaveis_contagem', models.ManyToManyField(help_text='Usuários responsáveis pela contagem', related_name='inventarios_contagem', to=settings.AUTH_USER_MODEL)),
                ('responsavel_planejamento', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='inventarios_planejados', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacoes', models.TextField(blank=True)),
                ('loja', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='movimentacoes_loja', to='core.loja')),
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movimentacoes_produto', to='produtos.produto')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='movimentacoes_usuario', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lote', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='produtos.lote')),
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alertas_estoque', to='produtos.produto')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['tipo_alerta', 'ativo'], name='estoque_ale_tipo_al_4ea9ac_idx'), models.Index(fields=['prioridade', 'ativo'], name='estoque_ale_priorid_a29c16_idx'), models.Index(fields=['produto', 'loja'], name='estoque_ale_produto_e9a776_idx')],
            },
        ),
        migrations.CreateModel(
            name='ItemInventario',
            fields=[
                ...
                ('usuario_contagem_1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contagens_1', to=settings.AUTH_USER_MODEL)),
                ('usuario_contagem_2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contagens_2', to=settings.AUTH_USER_MODEL)),
            ],
            options={

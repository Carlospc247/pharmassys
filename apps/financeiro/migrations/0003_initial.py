...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Movimentação de pagamento do imposto', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='impostos_pagos', to='financeiro.movimentacaofinanceira'),
        ),
        migrations.AddField(
            model_name='impostotributo',
            name='plano_contas',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='Conta do Plano de Contas (Ativo) associada a este Caixa/Banco.', on_delete=django.db.models.deletion.PROTECT, related_name='contas_bancarias_ativo', to='financeiro.planocontas'),
        ),
        migrations.AddField(
            model_name='configuracaoimposto',
            name='empresa',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='configuracao_impostos', to='core.empresa'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='impostotributo',
            index=models.Index(fields=['tipo_imposto', 'situacao'], name='financeiro__tipo_im_789785_idx'),
        ),
        migrations.AddIndex(
            model_name='impostotributo',
        ...
        migrations.AlterUniqueTogether(
            name='impostotributo',
            unique_together={('empresa', 'tipo_imposto', 'ano_referencia', 'mes_referencia')},
        ),
        migrations.AddIndex(
            model_name='contareceber',

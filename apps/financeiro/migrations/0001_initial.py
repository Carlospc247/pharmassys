    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(decimal_places=2, default=0, help_text='Valor total (devido + multa + juros)', max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conta_pai', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contas_filhas', to='financeiro.planocontas')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.empresa')),
                ('plano_contas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='financeiro.planocontas')),
            ],
            options={
